  ...
  build: {
    rollupOptions: {
      input: {
        ...
        performanceMarketing: resolve(__dirname, 'performance-marketing.html'),
        aiCreativeStudio: resolve(__dirname, 'ai-creative-studio.html'),
        aiUgcVideos: resolve(__dirname, 'ai-ugc-videos.html'),
        croLandingPages: resolve(__dirname, 'cro-landing-pages.html'),
        aiMarketingStrategy: resolve(__dirname, 'ai-marketing-strategy.html'),
        ecommerceGrowthRetainer: resolve(__dirname, 'ecommerce-growth-retainer.html'),
        socialMediaOptimization: resolve(__dirname, 'social-media-optimization.html'),
